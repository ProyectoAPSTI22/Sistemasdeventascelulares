...
<!-- Main Sidebar Container -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" id="one">
    <!-- Brand Logo -->
    <a href=".?" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SMARTPHONE PERU</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <nav class="mt-2 sticky-top">
        <ul class="centro nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <?php 
